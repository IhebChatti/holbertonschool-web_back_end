...
class BasicAuth(Auth):
    ...
    def extract_user_credentials(self,
        ...
        Returns:
            [type]: [ the user email and password ]
        """
    ...
    def current_user(self, request=None) -> TypeVar('User'):
        ...
        b64_auth_headers = self.extract_base64_authorization_header(auth_headers)
        decoded_b64_auth_headers = self.decode_base64_authorization_header(b64_auth_headers)
        user_credentials = self.extract_user_credentials(decoded_b64_auth_headers)
